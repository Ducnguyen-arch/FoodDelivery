...
// Định dạng lại giá tiền cho đẹp (ví dụ: 50000 -> 50.000)
    ...
    <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 d-flex justify-content-center">
       ...
       <Link to={`/food/${id}`}>
        ...
        <div className="card-body">
            ...
            <p className="card-text line-clamp-2 text-muted small">{description} </p>
            <div className="d-flex justify-content-between align-items-center">
                <span className="h5 mb-0">{formatPrice(price)} VND</span>
                <div>
        ...
        <div className="card-footer d-flex justify-content-between bg-light">
            <Link className="btn btn-primary btn-sm" to={`/food/${id}`}>Xem chi tiết</Link>
            {quantities[id] > 0 ? (
